...
export const registerCommandResponders = async () => {
    ...
    opendiscord.responders.commands.add(new api.ODCommandResponder("openticket:help",generalConfig.data.prefix,"help"))
    opendiscord.responders.commands.get("openticket:help").workers.add([
        ...
        new api.ODWorker("openticket:help",0,async (instance,params,source,cancel) => {
            ...
            await instance.reply(await opendiscord.builders.messages.getSafe("openticket:help-menu").build(source,{mode,page:0}))
        }),
...
export const registerButtonResponders = async () => {
    ...
    opendiscord.responders.buttons.add(new api.ODButtonResponder("openticket:help-menu-switch",/^od:help-menu-switch_(slash|text)/))
    opendiscord.responders.buttons.get("openticket:help-menu-switch").workers.add(
        new api.ODWorker("openticket:update-help-menu",0,async (instance,params,source,cancel) => {
            ...
            const msg = await opendiscord.builders.messages.getSafe("openticket:help-menu").build("button",{mode:newMode,page:currentPage})
            await instance.update(msg)
        })
    )

    //HELP MENU PREVIOUS BUTTON RESPONDER
    opendiscord.responders.buttons.add(new api.ODButtonResponder("openticket:help-menu-previous",/^od:help-menu-previous/))
    opendiscord.responders.buttons.get("openticket:help-menu-previous").workers.add(
        new api.ODWorker("openticket:update-help-menu",0,async (instance,params,source,cancel) => {
            ...
            const msg = await opendiscord.builders.messages.getSafe("openticket:help-menu").build("button",{mode:currentMode,page:currentPage-1})
            await instance.update(msg)
        })
    )

    //HELP MENU NEXT BUTTON RESPONDER
    opendiscord.responders.buttons.add(new api.ODButtonResponder("openticket:help-menu-next",/^od:help-menu-next/))
    opendiscord.responders.buttons.get("openticket:help-menu-next").workers.add(
        new api.ODWorker("openticket:update-help-menu",0,async (instance,params,source,cancel) => {
            const switchButton = instance.getMessageComponent("button",/^od:help-menu-switch_(slash|text)/)
            const pageButton = instance.getMessageComponent("button",/^od:help-menu-page_([0-9]+)/)
            const currentPage = (pageButton && pageButton.customId) ? Number(pageButton.customId.split("_")[1]) : 0
