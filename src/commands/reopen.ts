...
export const registerCommandResponders = async () => {
    ...
    opendiscord.responders.commands.add(new api.ODCommandResponder("openticket:reopen",generalConfig.data.prefix,"reopen"))
    opendiscord.responders.commands.get("openticket:reopen").workers.add([
        ...
        new api.ODWorker("openticket:reopen",0,async (instance,params,source,cancel) => {
            ...
            await opendiscord.actions.get("openticket:reopen-ticket").run(source,{guild,channel,user,ticket,reason,sendMessage:false})
            await instance.reply(await opendiscord.builders.messages.getSafe("openticket:reopen-message").build(source,{guild,channel,user,ticket,reason}))
        }),
...
export const registerButtonResponders = async () => {
    ...
    opendiscord.responders.buttons.add(new api.ODButtonResponder("openticket:reopen-ticket",/^od:reopen-ticket/))
    opendiscord.responders.buttons.get("openticket:reopen-ticket").workers.add(
        new api.ODWorker("openticket:reopen-ticket",0,async (instance,params,source,cancel) => {
            ...
            if (originalSource == "ticket-message") await opendiscord.verifybars.get("openticket:reopen-ticket-ticket-message").activate(instance)
            else if (originalSource == "close-message") await opendiscord.verifybars.get("openticket:reopen-ticket-close-message").activate(instance)
            else await opendiscord.verifybars.get("openticket:reopen-ticket-autoclose-message").activate(instance)
        })
    )
}
...
export const registerModalResponders = async () => {
    ...
    opendiscord.responders.modals.get("openticket:reopen-ticket-reason").workers.add([
        new api.ODWorker("openticket:reopen-ticket-reason",0,async (instance,params,source,cancel) => {
            ...
            if (originalSource == "ticket-message"){
                ...
                await opendiscord.actions.get("openticket:reopen-ticket").run(originalSource,{guild,channel,user,ticket,reason,sendMessage:true})
                ...
                await instance.defer("update",false)
                await opendiscord.actions.get("openticket:reopen-ticket").run(originalSource,{guild,channel,user,ticket,reason,sendMessage:false})
